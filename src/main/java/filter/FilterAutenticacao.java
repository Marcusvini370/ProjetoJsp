...
public class FilterAutenticacao implements Filter {
	...
	/* Intercepra as requisições e as respostas do sistema */
	...
	try {
		...
		/* Validase está logado senão redireciona para a dela de login */
...
/* Inicia os processos ou recursos quando o servidor sobe o projeto */
	//EX: iniciar a conexão com o banco quando subir o proejto
